...
def add_new_rule(source, port, action="block", interface="wan", protocol="tcp", destination="NET:lan"):
    command_string = 'ansible-playbook {} -i ./playbook/services.yaml --extra-vars "action_pfsense={} interface_pfsense={} protocol_pfsense={} source_pfsense={} dest_ansible={} port_pfsense={}"'.format(action, interface, protocol, source, destination, port)
